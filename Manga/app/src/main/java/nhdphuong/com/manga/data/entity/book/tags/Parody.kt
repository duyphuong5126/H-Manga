...
data class Parody(
    ...
    constructor(parcel: Parcel) : this(
            parcel.readLong(),
            parcel.readString() ?: Constants.PARODY,
            parcel.readString() ?: "",
            parcel.readString() ?: "",
            parcel.readLong()
    )
    ...
    companion object CREATOR : Parcelable.Creator<Parody> {
        override fun createFromParcel(parcel: Parcel): Parody {
            return Parody(parcel)
        }

        override fun newArray(size: Int): Array<Parody?> {
